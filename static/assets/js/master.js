    ...
    * ================================================================= */
    ...
    $(function () {
        ...
        $('#contact-form').on('submit', function (e) {
            if (!e.isDefaultPrevented()) {
                ...
                var url = "https://formspree.io/iqube@kct.ac.in";
                var name = $('#name').value();
                var subject = $('#subject').value();
                var email = $('#email').value();
                var desc = $(' #message').value();
    ...
    /* ===== GOOGLE MAPS  ===== */
        if ($('#myMap').length > 0) {
                ...
                var $latitude = 11.0778669, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
                        $longitude = 76.9876438,
